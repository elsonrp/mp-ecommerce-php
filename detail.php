...
$preference->back_urls=array("success"=>"https://" . $_SERVER['SERVER_NAME']."/aprovado.php",
                             "pending"=>"https://" . $_SERVER['SERVER_NAME']."/pendente.php",
                             "failure"=>"https://" . $_SERVER['SERVER_NAME']."/nao-concluido.php");
